...
/**
 * QatLz4104Codec provides an LZ4 compressor using the <a
 * href="https://github.com/intel/qat-java">qat-java</a> library.
 */
public class QatLz4104Codec extends Lucene104QatCodec implements CodecSettings, CodecAliases {

    /** Creates a new QatLz4104Codec instance with the default compression level. */
    public QatLz4104Codec() {
        this(DEFAULT_COMPRESSION_LEVEL);
    }

    /**
     * Creates a new QatLz4104Codec instance.
     *
     * @param compressionLevel The compression level.
     */
    public QatLz4104Codec(int compressionLevel) {
     ...
     */
    public QatLz4104Codec(int compressionLevel, Supplier<QatZipper.Mode> supplier) {
     ...
     * @param compressionLevel The compression level.
     */
    public QatLz4104Codec(Supplier<Codec> defaultCodecSupplier, int compressionLevel) {
     ...
     * @param defaultCodecSupplier default opensearch codec supplier
     */
    public QatLz4104Codec(int compressionLevel, Supplier<QatZipper.Mode> supplier, Supplier<Codec> defaultCodecSupplier) {
