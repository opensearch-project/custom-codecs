...
public class Lucene104QatStoredFieldsFormat extends StoredFieldsFormat {

    /** A key that we use to map to a mode */
    public static final String MODE_KEY = Lucene104QatStoredFieldsFormat.class.getSimpleName() + ".mode";
    ...
    private final Lucene104QatCodec.Mode mode;

    /** default constructor */
    public Lucene104QatStoredFieldsFormat() {
        this(Lucene104QatCodec.DEFAULT_COMPRESSION_MODE, DEFAULT_COMPRESSION_LEVEL);
    }
     ...
     */
    public Lucene104QatStoredFieldsFormat(Lucene104QatCodec.Mode mode) {
     ...
     */
    public Lucene104QatStoredFieldsFormat(Lucene104QatCodec.Mode mode, int compressionLevel) {
     ...
     */
    public Lucene104QatStoredFieldsFormat(Lucene104QatCodec.Mode mode, Supplier<QatZipper.Mode> supplier) {
     ...
     * @param supplier a supplier for QAT acceleration mode.
     */
    public Lucene104QatStoredFieldsFormat(Lucene104QatCodec.Mode mode, int compressionLevel, Supplier<QatZipper.Mode> supplier) {
    ...
    public StoredFieldsReader fieldsReader(Directory directory, SegmentInfo si, FieldInfos fn, IOContext context) throws IOException {
        if (si.getAttribute(MODE_KEY) != null) {
            ...
            Lucene104QatCodec.Mode mode = Lucene104QatCodec.Mode.valueOf(value);
    ...
    private StoredFieldsFormat impl(Lucene104QatCodec.Mode mode) {
        switch (mode) {
            case QAT_LZ4:
     ...
     */
    public Lucene104QatCodec.Mode getMode() {
        return mode;
    }
    ...
    /**
     * Returns {@link QatZipper.Algorithm} instance that corresponds codec's {@link Lucene104QatCodec.Mode mode}
     * @param mode codec's {@link Lucene104QatCodec.Mode mode}
     * @return the {@link QatZipper.Algorithm} instance that corresponds codec's {@link Lucene104QatCodec.Mode mode}
     */
    private static QatZipper.Algorithm getAlgorithm(Lucene104QatCodec.Mode mode) {
        switch (mode) {
            case QAT_LZ4:
