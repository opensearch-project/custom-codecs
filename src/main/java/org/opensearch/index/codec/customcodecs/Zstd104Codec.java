 ...
 */
public class Zstd104Codec extends Lucene104CustomCodec implements CodecSettings, CodecAliases {
     ...
     */
    public Zstd104Codec(int compressionLevel) {
     ...
     */
    public Zstd104Codec(int compressionLevel, Supplier<Codec> defaultCodecSupplier) {
