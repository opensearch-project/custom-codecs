...
public class ZstdNoDict103Codec extends Lucene103CustomCodec implements CodecSettings, CodecAliases {

    /** Creates a new ZstdNoDictCodec instance with the default compression level. */
    public ZstdNoDict103Codec() {
     ...
     */
    public ZstdNoDict103Codec(int compressionLevel) {
     ...
     */
    public ZstdNoDict103Codec(int compressionLevel, Supplier<Codec> defaultCodecSupplier) {
