 ...
 */
public class QatDeflate104Codec extends Lucene104QatCodec implements CodecSettings, CodecAliases {

    /** Creates a new QatDeflate101Codec instance with the default compression level. */
    public QatDeflate104Codec() {
     ...
     */
    public QatDeflate104Codec(int compressionLevel) {
     ...
     */
    public QatDeflate104Codec(int compressionLevel, Supplier<QatZipper.Mode> supplier) {
     ...
     * @param compressionLevel The compression level.
     */
    public QatDeflate104Codec(Supplier<Codec> defaultCodecSupplier, int compressionLevel) {
     ...
     * @param defaultCodecSupplier default opensearch codec supplier
     */
    public QatDeflate104Codec(int compressionLevel, Supplier<QatZipper.Mode> supplier, Supplier<Codec> defaultCodecSupplier) {
