 ...
 */
public class QatDeflate103Codec extends Lucene103QatCodec implements CodecSettings, CodecAliases {

    /** Creates a new QatDeflate101Codec instance with the default compression level. */
    public QatDeflate103Codec() {
     ...
     */
    public QatDeflate103Codec(int compressionLevel) {
     ...
     */
    public QatDeflate103Codec(int compressionLevel, Supplier<QatZipper.Mode> supplier) {
     ...
     * @param compressionLevel The compression level.
     */
    public QatDeflate103Codec(Supplier<Codec> defaultCodecSupplier, int compressionLevel) {
     ...
     * @param defaultCodecSupplier default opensearch codec supplier
     */
    public QatDeflate103Codec(int compressionLevel, Supplier<QatZipper.Mode> supplier, Supplier<Codec> defaultCodecSupplier) {
